...
<body>
  ...
  <script src="http://localhost/siperpus/aset/bootstrap/css/bootstrap.min.css"></script>
  <script src="http://localhost/siperpus/aset/fontawesome/css/all.min.css"></script>
